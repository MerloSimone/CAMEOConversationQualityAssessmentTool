...
with open('./data/labelstudio_INTERFACE_comparison.txt','r') as fp:
	for line in fp:
...
body_as_dict = {"title": "Conversation Comparison", "description": "Conversation Comparison Task", "enable_empty_annotation": False,"maximum_annotations": 1,"expert_instruction": "Label all conversations pairs and all properties", "label_config": label_config}
