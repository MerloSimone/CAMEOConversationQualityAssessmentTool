...
body_as_dict = {"title": "Conversation Annotation", "description": "Conversation Annotation Task", "enable_empty_annotation": False,"maximum_annotations": 1,"expert_instruction": "Label all conversations and all properties", "label_config": label_config}
